...
namespace Skoruba.IdentityServer4.Admin.BusinessLogic.Identity.Services.Interfaces
{
        ...
        where TRoleClaimDto : RoleClaimDto<TKey>
    {
        ...
        Task<TApplicationsDto> GetApplicationsAsync(string search, int page = 1, int pageSize = 10);
        ...
        Task<TRoleClaimsDto> GetRolePermissionsAsync(string roleId, int page = 1, int pageSize = 10);
    }
}